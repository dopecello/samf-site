...
<div class="flex flex-col items-center py-8 mb-10 border-b-2 lg:items-start lg:flex-row custom:justify-center custom:gap-5 post-custom:justify-between post-custom:gap-0 border-neutral-900 dark:border-neutral-300 lg:mb-12">
